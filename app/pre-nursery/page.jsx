...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Pre-Nursery Class" />
            <HeaderOne />
            <BreadCrumb title="Pre-Nursery Class" innerTitle="Pre-Nursery Class" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Early Childhood Care & Sensory Learning</span>
                                <h2 className="mb-4 text-dark fw-bold">Pre-Nursery Class</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    A gentle, playful introduction to structured learning, sensory discovery, motor skill development, and social bonding.
                                </p>
