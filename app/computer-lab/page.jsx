...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Computer Lab & IT Center" />
            <HeaderOne />
            <BreadCrumb title="Computer Lab & IT Center" innerTitle="Computer Lab & IT Center" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Modern Computing & Digital Literacy</span>
                                <h2 className="mb-4 text-dark fw-bold">Computer Lab & IT Center</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    High-speed internet-connected workstations equipped with modern software for coding, digital skills, graphic design, and research.
                                </p>
