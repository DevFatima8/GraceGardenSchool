...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 3-B" />
            <HeaderOne />
            <BreadCrumb title="Class 3-B" innerTitle="Class 3-B" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Class 3-B</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Promoting analytical thinking, creative writing, scientific inquiry, and healthy collaborative group work.
                                </p>
