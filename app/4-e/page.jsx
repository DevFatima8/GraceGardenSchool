...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 4-E (2nd Shift)" />
            <HeaderOne />
            <BreadCrumb title="Class 4-E (2nd Shift)" innerTitle="Class 4-E (2nd Shift)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Class 4-E (2nd Shift)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Engaging curriculum, lab access, and extracurricular opportunities in the afternoon program.
                                </p>
