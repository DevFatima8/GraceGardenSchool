...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Cambridge Section Coordinator" />
            <HeaderOne />
            <BreadCrumb title="Cambridge Section Coordinator" innerTitle="Cambridge Section Coordinator" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Cambridge International Curriculum Oversight</span>
                                <h2 className="mb-4 text-dark fw-bold">Cambridge Section Coordinator</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Directing Cambridge Lower Secondary and O-Level academic programs in accordance with Cambridge Assessment International Education (CAIE) guidelines.
                                </p>
