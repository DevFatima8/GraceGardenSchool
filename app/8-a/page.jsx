...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 8-A" />
            <HeaderOne />
            <BreadCrumb title="Class 8-A" innerTitle="Class 8-A" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Middle School Section - Pre-Secondary</span>
                                <h2 className="mb-4 text-dark fw-bold">Class 8-A</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Preparing for board-level rigor, subject stream selection (Matric/Cambridge), and advanced conceptual mastery.
                                </p>
