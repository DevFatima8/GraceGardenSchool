...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Commitment to Character & Conduct" />
            <HeaderOne />
            <BreadCrumb title="Commitment to Character & Conduct" innerTitle="Commitment to Character & Conduct" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Values, Ethics & Discipline</span>
                                <h2 className="mb-4 text-dark fw-bold">Commitment to Character & Conduct</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Grace Garden School emphasizes moral integrity, civic responsibility, mutual respect, and disciplined conduct in every student.
                                </p>
