...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Result Day: A Parent Reset Plan" />
            <HeaderOne />
            <BreadCrumb title="Result Day: A Parent Reset Plan" innerTitle="Result Day: A Parent Reset Plan" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Constructive Reflection & Encouragement</span>
                                <h2 className="mb-4 text-dark fw-bold">Result Day: A Parent Reset Plan</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    How to approach academic report cards with empathy, recognize effort over perfection, and create supportive improvement goals with your child.
                                </p>
