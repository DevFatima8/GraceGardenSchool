...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Dress Code & Uniform Rules" />
            <HeaderOne />
            <BreadCrumb title="Dress Code & Uniform Rules" innerTitle="Dress Code & Uniform Rules" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Neatness, Identity & Discipline</span>
                                <h2 className="mb-4 text-dark fw-bold">Dress Code & Uniform Rules</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Comprehensive guidelines on Grace Garden School’s official student uniform, seasonal wear, grooming standards, and dress code policies.
                                </p>
