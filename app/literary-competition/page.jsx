...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Literary Competition" />
            <HeaderOne />
            <BreadCrumb title="Literary Competition" innerTitle="Literary Competition" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Debates, Speeches & Creative Writing</span>
                                <h2 className="mb-4 text-dark fw-bold">Literary Competition</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Fostering eloquence, critical thought, and literary appreciation in English and Urdu debates, declamation contests, and essay writing.
                                </p>
