...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Guide for Choosing the Best School" />
            <HeaderOne />
            <BreadCrumb title="Guide for Choosing the Best School" innerTitle="Guide for Choosing the Best School" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Making the Right Choice for Your Child</span>
                                <h2 className="mb-4 text-dark fw-bold">Guide for Choosing the Best School</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Key factors to consider when selecting an educational institution: academic standards, teacher qualifications, facilities, values, and student well-being.
                                </p>
