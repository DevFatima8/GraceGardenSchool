...
const Page = () => {
    return (
        <>
            <SEO pageTitle="School Day Celebrations" />
            <HeaderOne />
            <BreadCrumb title="School Day Celebrations" innerTitle="School Day Celebrations" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Honoring Excellence & School Spirit</span>
                                <h2 className="mb-4 text-dark fw-bold">School Day Celebrations</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    A grand celebration celebrating foundation day, student achievements, faculty dedication, and parent partnerships.
                                </p>
