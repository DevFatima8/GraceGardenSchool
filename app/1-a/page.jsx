...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 1-A" />
            <HeaderOne />
            <BreadCrumb title="Class 1-A" innerTitle="Class 1-A" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Primary Education Wing</span>
                                <h2 className="mb-4 text-dark fw-bold">Class 1-A</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Cultivating core literacy, numeracy, environmental awareness, and creative expression in a vibrant classroom atmosphere.
                                </p>
