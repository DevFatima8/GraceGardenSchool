...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Service Learning" />
            <HeaderOne />
            <BreadCrumb title="Service Learning" innerTitle="Service Learning" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Learning by Helping Others</span>
                                <h2 className="mb-4 text-dark fw-bold">Service Learning</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Integrating classroom knowledge with hands-on community service to develop compassionate, proactive, and socially responsible citizens.
                                </p>
