...
const Page = () => {
    return (
        <>
            <SEO pageTitle="ACE - Academic Center of Excellence" />
            <HeaderOne />
            <BreadCrumb title="ACE - Academic Center of Excellence" innerTitle="ACE - Academic Center of Excellence" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Curriculum Design, Quality Assurance & Faculty Training</span>
                                <h2 className="mb-4 text-dark fw-bold">ACE - Academic Center of Excellence</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    The Academic Center of Excellence (ACE) oversees curriculum standards, innovative pedagogy, periodic assessments, and continuous professional development for our teaching staff.
                                </p>
