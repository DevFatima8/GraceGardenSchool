...
const defaultContent = {
  ...
  intro: {
    title: "ACE (Academic Excellence)",
    subtitle: "Departments",
    description: "Welcome to the ACE (Academic Excellence) department at Grace Garden School. Our focus is to ensure the highest standards of education and management, providing continuous support to both our faculty and students.",
    image_url: "/uploads/academics.jpg"
  },
  roles: {
...
export default function Page() {
    return <GenericPage pageSlug="ace" pageTitle="ACE (Academic Excellence)" defaultContent={defaultContent} />;
}
