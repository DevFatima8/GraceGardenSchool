...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 10-A" />
            <HeaderOne />
            <BreadCrumb title="Class 10-A" innerTitle="Class 10-A" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Matriculation Board Wing - Final Year</span>
                                <h2 className="mb-4 text-dark fw-bold">Class 10-A</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Targeted exam preparation, test sessions, comprehensive revisions, and individualized mentoring for outstanding board results.
                                </p>
