...
const defaultContent = {
  ...
  intro: {
    ...
    description: "Welcome to Class 6 A at Grace Garden School. Our Middle Section is designed to foster a love for learning in a supportive and engaging environment. We focus on holistic development, combining academic excellence with character building.",
    image_url: "/uploads/activities.jpg"
  },
  curriculum: {
    title: "Curriculum & Activities",
    subtitle: "What we learn",
    description: "Our curriculum is carefully crafted to meet the developmental needs of students in Class 6 A.",
    json_data: [
      {
        title: "Core Subjects",
...
export default function Page() {
    return <GenericPage pageSlug="6-a" pageTitle="Class 6 A" defaultContent={defaultContent} />;
}
