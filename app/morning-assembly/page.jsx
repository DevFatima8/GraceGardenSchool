...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Morning Assembly" />
            <HeaderOne />
            <BreadCrumb title="Morning Assembly" innerTitle="Morning Assembly" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Starting the Day with Inspiration & Unity</span>
                                <h2 className="mb-4 text-dark fw-bold">Morning Assembly</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Our morning assembly fosters spiritual grounding, national pride, public speaking skills, and daily motivation for students and faculty.
                                </p>
