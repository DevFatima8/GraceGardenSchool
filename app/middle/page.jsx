...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Middle School Coordinator" />
            <HeaderOne />
            <BreadCrumb title="Middle School Coordinator" innerTitle="Middle School Coordinator" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Grades 6, 7 & 8 Academic Coordination</span>
                                <h2 className="mb-4 text-dark fw-bold">Middle School Coordinator</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Supervising middle school curriculum delivery, science projects, co-curricular societies, and student mentorship.
                                </p>
