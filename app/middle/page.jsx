...
const defaultContent = {
  ...
  intro: {
    ...
    description: "Welcome to the Middle Section Coordinator department at Grace Garden School. Our focus is to ensure the highest standards of education and management, providing continuous support to both our faculty and students.",
    image_url: "/uploads/faculty.jpg"
  },
  roles: {
...
export default function Page() {
    return <GenericPage pageSlug="middle" pageTitle="Middle Section Coordinator" defaultContent={defaultContent} />;
}
