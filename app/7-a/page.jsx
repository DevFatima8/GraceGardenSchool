...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 7-A" />
            <HeaderOne />
            <BreadCrumb title="Class 7-A" innerTitle="Class 7-A" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Class 7-A</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Deepening analytical capabilities, science laboratory work, critical essay writing, and mathematical problem-solving.
                                </p>
