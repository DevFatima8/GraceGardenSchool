...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Why Early Year Education Matters" />
            <HeaderOne />
            <BreadCrumb title="Why Early Year Education Matters" innerTitle="Why Early Year Education Matters" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Building Lifelong Foundations</span>
                                <h2 className="mb-4 text-dark fw-bold">Why Early Year Education Matters</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Exploring how holistic play-based inquiry, emotional nurturing, and foundational literacy in early childhood shape future academic success.
                                </p>
