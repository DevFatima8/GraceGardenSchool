...
const defaultContent = {
  ...
  intro: {
    title: "Upper Primary Coordinator",
    subtitle: "Coordinators",
    description: "Welcome to the Upper Primary Coordinator department at Grace Garden School. Our focus is to ensure the highest standards of education and management, providing continuous support to both our faculty and students.",
    image_url: "/uploads/faculty.jpg"
  },
  roles: {
...
export default function Page() {
    return <GenericPage pageSlug="upper-primary" pageTitle="Upper Primary Coordinator" defaultContent={defaultContent} />;
}
