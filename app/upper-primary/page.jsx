...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Upper Primary Wing Coordinator" />
            <HeaderOne />
            <BreadCrumb title="Upper Primary Wing Coordinator" innerTitle="Upper Primary Wing Coordinator" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Grades 3, 4 & 5 Academic Coordination</span>
                                <h2 className="mb-4 text-dark fw-bold">Upper Primary Wing Coordinator</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Guiding upper primary students toward independent thinking, scientific curiosity, and academic discipline.
                                </p>
