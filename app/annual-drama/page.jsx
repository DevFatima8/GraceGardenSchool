...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Annual Drama" />
            <HeaderOne />
            <BreadCrumb title="Annual Drama" innerTitle="Annual Drama" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Theatrical Arts & Creative Expression</span>
                                <h2 className="mb-4 text-dark fw-bold">Annual Drama</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Showcasing our students’ creative flair, stage performance, storytelling, and artistic expression through annual theatrical productions.
                                </p>
