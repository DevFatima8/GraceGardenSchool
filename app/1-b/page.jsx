...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 1-B" />
            <HeaderOne />
            <BreadCrumb title="Class 1-B" innerTitle="Class 1-B" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Class 1-B</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Fostering collaborative learning, reading enthusiasm, basic arithmetic, and social values for young primary learners.
                                </p>
