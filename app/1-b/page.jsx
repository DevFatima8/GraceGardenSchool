...
const defaultContent = {
  ...
  intro: {
    ...
    description: "Welcome to Class 1 B at Grace Garden School. Our Primary Section is designed to foster a love for learning in a supportive and engaging environment. We focus on holistic development, combining academic excellence with character building.",
    image_url: "/uploads/academics.jpg"
  },
  curriculum: {
    title: "Curriculum & Activities",
    subtitle: "What we learn",
    description: "Our curriculum is carefully crafted to meet the developmental needs of students in Class 1 B.",
    json_data: [
      {
        title: "Core Subjects",
...
export default function Page() {
    return <GenericPage pageSlug="1-b" pageTitle="Class 1 B" defaultContent={defaultContent} />;
}
