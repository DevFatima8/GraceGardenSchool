...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Brain Competition" />
            <HeaderOne />
            <BreadCrumb title="Brain Competition" innerTitle="Brain Competition" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Quiz, Logic & Academic Brilliance</span>
                                <h2 className="mb-4 text-dark fw-bold">Brain Competition</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    An intellectual contest testing general knowledge, logical reasoning, mathematics, and scientific acumen across all grade levels.
                                </p>
