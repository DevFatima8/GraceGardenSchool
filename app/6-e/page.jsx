...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 6-E (2nd Shift)" />
            <HeaderOne />
            <BreadCrumb title="Class 6-E (2nd Shift)" innerTitle="Class 6-E (2nd Shift)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Afternoon Middle Section</span>
                                <h2 className="mb-4 text-dark fw-bold">Class 6-E (2nd Shift)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Middle school academic subjects, computer literacy, and character development in the afternoon shift.
                                </p>
