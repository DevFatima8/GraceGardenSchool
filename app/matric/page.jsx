...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Matriculation Wing Coordinator" />
            <HeaderOne />
            <BreadCrumb title="Matriculation Wing Coordinator" innerTitle="Matriculation Wing Coordinator" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Grades 9 & 10 BISE Lahore Board Coordination</span>
                                <h2 className="mb-4 text-dark fw-bold">Matriculation Wing Coordinator</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Specialized academic oversight for BISE board preparation, syllabus completion, test schedules, and laboratory practicals.
                                </p>
