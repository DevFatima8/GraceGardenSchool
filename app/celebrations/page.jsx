...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Festivals & Celebrations" />
            <HeaderOne />
            <BreadCrumb title="Festivals & Celebrations" innerTitle="Festivals & Celebrations" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Cultural Harmony & Festive Joy</span>
                                <h2 className="mb-4 text-dark fw-bold">Festivals & Celebrations</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Marking Pakistan Day, Independence Day, Eid, Christmas, Iqbal Day, and Global Peace Days with unity, joy, and cultural pride.
                                </p>
