...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Lower Primary Wing Coordinator" />
            <HeaderOne />
            <BreadCrumb title="Lower Primary Wing Coordinator" innerTitle="Lower Primary Wing Coordinator" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Grades 1 & 2 Academic Coordination</span>
                                <h2 className="mb-4 text-dark fw-bold">Lower Primary Wing Coordinator</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Ensuring smooth transition from kindergarten to structured primary education with emphasis on literacy, numeracy, and social integration.
                                </p>
