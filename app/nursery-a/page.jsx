...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Nursery A Class" />
            <HeaderOne />
            <BreadCrumb title="Nursery A Class" innerTitle="Nursery A Class" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Foundational Phonics, Numbers & Social Skills</span>
                                <h2 className="mb-4 text-dark fw-bold">Nursery A Class</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Building early language skills, numeric concepts, social etiquette, and creative curiosity through interactive Montessori methods.
                                </p>
