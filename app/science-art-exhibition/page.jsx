...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Science & Art Exhibition" />
            <HeaderOne />
            <BreadCrumb title="Science & Art Exhibition" innerTitle="Science & Art Exhibition" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Innovation, Creativity & Discovery</span>
                                <h2 className="mb-4 text-dark fw-bold">Science & Art Exhibition</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    An inspiring platform where students display working STEM models, robotics experiments, visual art masterpieces, and creative crafts.
                                </p>
