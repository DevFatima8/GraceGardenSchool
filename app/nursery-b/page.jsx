...
const defaultContent = {
  ...
  intro: {
    title: "Nursery B",
    subtitle: "Pre School",
    description: "Welcome to Nursery B at Grace Garden School. Our Pre School is designed to foster a love for learning in a supportive and engaging environment. We focus on holistic development, combining academic excellence with character building.",
    image_url: "/uploads/pre_school.jpg"
  },
  curriculum: {
    title: "Curriculum & Activities",
    subtitle: "What we learn",
    description: "Our curriculum is carefully crafted to meet the developmental needs of students in Nursery B.",
    json_data: [
      {
        title: "Core Subjects",
...
export default function Page() {
    return <GenericPage pageSlug="nursery-b" pageTitle="Nursery B" defaultContent={defaultContent} />;
}
