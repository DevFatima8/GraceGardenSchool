...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Nursery B Class" />
            <HeaderOne />
            <BreadCrumb title="Nursery B Class" innerTitle="Nursery B Class" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Nursery B Class</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Interactive classroom learning focusing on cognitive development, phonics, fine motor activities, and creative storytelling.
                                </p>
