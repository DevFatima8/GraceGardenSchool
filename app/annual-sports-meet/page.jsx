...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Annual Sports Meet" />
            <HeaderOne />
            <BreadCrumb title="Annual Sports Meet" innerTitle="Annual Sports Meet" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Athletics, Teamwork & Sportsmanship</span>
                                <h2 className="mb-4 text-dark fw-bold">Annual Sports Meet</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Celebrating athleticism, endurance, team spirit, and healthy competition with track events, football, cricket, badminton, and gymnastics.
                                </p>
