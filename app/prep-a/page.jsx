...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Prep A Class" />
            <HeaderOne />
            <BreadCrumb title="Prep A Class" innerTitle="Prep A Class" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Preparing for Primary Schooling</span>
                                <h2 className="mb-4 text-dark fw-bold">Prep A Class</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Strengthening reading, writing, mathematical comprehension, and inquiry-based problem solving to ensure a confident leap into Grade 1.
                                </p>
