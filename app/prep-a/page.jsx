...
const defaultContent = {
  ...
  intro: {
    title: "Prep A",
    subtitle: "Pre School",
    description: "Welcome to Prep A at Grace Garden School. Our Pre School is designed to foster a love for learning in a supportive and engaging environment. We focus on holistic development, combining academic excellence with character building.",
    image_url: "/uploads/pre_school.jpg"
  },
  curriculum: {
    title: "Curriculum & Activities",
    subtitle: "What we learn",
    description: "Our curriculum is carefully crafted to meet the developmental needs of students in Prep A.",
    json_data: [
      {
        title: "Core Subjects",
...
export default function Page() {
    return <GenericPage pageSlug="prep-a" pageTitle="Prep A" defaultContent={defaultContent} />;
}
