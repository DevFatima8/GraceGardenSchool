...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Virtual Tour" />
            <HeaderOne />
            <BreadCrumb title="Virtual Tour" innerTitle="Virtual Tour" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Explore Grace Garden School Campus</span>
                                <h2 className="mb-4 text-dark fw-bold">Virtual Tour</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Take an interactive virtual walkthrough of our state-of-the-art campus facilities, classrooms, playgrounds, and specialized labs in Green Town, Lahore.
                                </p>
