...
const defaultContent = {
  ...
  intro: {
    title: "SET (Student Evaluation & Testing)",
    subtitle: "Departments",
    description: "Welcome to the SET (Student Evaluation & Testing) department at Grace Garden School. Our focus is to ensure the highest standards of education and management, providing continuous support to both our faculty and students.",
    image_url: "/uploads/test.jpg"
  },
  roles: {
...
export default function Page() {
    return <GenericPage pageSlug="set" pageTitle="SET (Student Evaluation & Testing)" defaultContent={defaultContent} />;
}
