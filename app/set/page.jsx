...
const Page = () => {
    return (
        <>
            <SEO pageTitle="SET - Student Enrichment & Training" />
            <HeaderOne />
            <BreadCrumb title="SET - Student Enrichment & Training" innerTitle="SET - Student Enrichment & Training" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Holistic Student Development & Counseling</span>
                                <h2 className="mb-4 text-dark fw-bold">SET - Student Enrichment & Training</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    The Student Enrichment & Training (SET) department leads career guidance, student counseling, leadership training, and co-curricular enrichment.
                                </p>
