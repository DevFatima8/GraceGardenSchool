...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Specialized Courses (Chinese, AI, Robotics)" />
            <HeaderOne />
            <BreadCrumb title="Specialized Courses (Chinese, AI, Robotics)" innerTitle="Specialized Courses (Chinese, AI, Robotics)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Future-Ready Skills & Languages</span>
                                <h2 className="mb-4 text-dark fw-bold">Specialized Courses (Chinese, AI, Robotics)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Empowering learners with modern 21st-century capabilities including conversational Mandarin Chinese, Artificial Intelligence basics, and STEM Robotics.
                                </p>
