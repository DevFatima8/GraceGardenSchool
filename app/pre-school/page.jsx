...
const defaultContent = {
  ...
  intro: {
    ...
    description: "Welcome to the Pre-School Coordinator department at Grace Garden School. Our focus is to ensure the highest standards of education and management, providing continuous support to both our faculty and students.",
    image_url: "/uploads/faculty.jpg"
  },
  roles: {
...
export default function Page() {
    return <GenericPage pageSlug="pre-school" pageTitle="Pre-School Coordinator" defaultContent={defaultContent} />;
}
