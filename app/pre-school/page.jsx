...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Pre-School Wing Coordinator" />
            <HeaderOne />
            <BreadCrumb title="Pre-School Wing Coordinator" innerTitle="Pre-School Wing Coordinator" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Early Childhood Guidance & Support</span>
                                <h2 className="mb-4 text-dark fw-bold">Pre-School Wing Coordinator</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Dedicated leadership overseeing Kindergarten, Nursery, and Prep classes with a warm, caring, and nurturing developmental environment.
                                </p>
