...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Nursery 2nd Shift (E)" />
            <HeaderOne />
            <BreadCrumb title="Nursery 2nd Shift (E)" innerTitle="Nursery 2nd Shift (E)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Afternoon Education Program</span>
                                <h2 className="mb-4 text-dark fw-bold">Nursery 2nd Shift (E)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    High quality early education in our afternoon shift, providing flexible scheduling and equal academic excellence.
                                </p>
