...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Class 9-A" />
            <HeaderOne />
            <BreadCrumb title="Class 9-A" innerTitle="Class 9-A" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Matriculation Board Wing</span>
                                <h2 className="mb-4 text-dark fw-bold">Class 9-A</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Rigorous BISE Lahore board preparation in Science (Physics, Chemistry, Biology / Computer Science) with dedicated lab work and past paper practice.
                                </p>
