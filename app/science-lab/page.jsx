...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Science Laboratories" />
            <HeaderOne />
            <BreadCrumb title="Science Laboratories" innerTitle="Science Laboratories" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Hands-on Experiments in Physics, Chemistry & Biology</span>
                                <h2 className="mb-4 text-dark fw-bold">Science Laboratories</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Fully equipped physics, chemistry, and biology laboratories meeting national and international safety and experimentation standards.
                                </p>
