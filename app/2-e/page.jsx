...
const defaultContent = {
  ...
  intro: {
    title: "Class 2 E",
    subtitle: "2nd Shift",
    description: "Welcome to Class 2 E at Grace Garden School. Our 2nd Shift is designed to foster a love for learning in a supportive and engaging environment. We focus on holistic development, combining academic excellence with character building.",
    image_url: "/uploads/facilities.jpg"
  },
  curriculum: {
    title: "Curriculum & Activities",
    subtitle: "What we learn",
    description: "Our curriculum is carefully crafted to meet the developmental needs of students in Class 2 E.",
    json_data: [
      {
        title: "Core Subjects",
...
export default function Page() {
    return <GenericPage pageSlug="2-e" pageTitle="Class 2 E" defaultContent={defaultContent} />;
}
