...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Clubs & Societies" />
            <HeaderOne />
            <BreadCrumb title="Clubs & Societies" innerTitle="Clubs & Societies" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Nurturing Passions Beyond Textbooks</span>
                                <h2 className="mb-4 text-dark fw-bold">Clubs & Societies</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Join diverse student clubs including Robotics, Debating, Environmental Action, Coding, Arts & Crafts, Drama, and Music.
                                </p>
