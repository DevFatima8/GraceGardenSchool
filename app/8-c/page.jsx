...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Grade 8-C (Cambridge)" />
            <HeaderOne />
            <BreadCrumb title="Grade 8-C (Cambridge)" innerTitle="Grade 8-C (Cambridge)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Grade 8-C (Cambridge)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Preparation for Cambridge Checkpoint examinations and comprehensive grounding for O-Level subject selection.
                                </p>
