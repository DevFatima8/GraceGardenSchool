...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Outreach Programs" />
            <HeaderOne />
            <BreadCrumb title="Outreach Programs" innerTitle="Outreach Programs" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Community Service & Social Impact</span>
                                <h2 className="mb-4 text-dark fw-bold">Outreach Programs</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Empowering students to connect with society through charity drives, environmental campaigns, and community welfare initiatives.
                                </p>
