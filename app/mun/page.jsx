...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Model United Nations (MUN)" />
            <HeaderOne />
            <BreadCrumb title="Model United Nations (MUN)" innerTitle="Model United Nations (MUN)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Diplomacy, Debate & Global Leadership</span>
                                <h2 className="mb-4 text-dark fw-bold">Model United Nations (MUN)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Training future diplomats and global thinkers in parliamentary debate, international relations, conflict resolution, and public speaking.
                                </p>
