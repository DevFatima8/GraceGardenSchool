...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Prep 2nd Shift (E)" />
            <HeaderOne />
            <BreadCrumb title="Prep 2nd Shift (E)" innerTitle="Prep 2nd Shift (E)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Prep 2nd Shift (E)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Structured preparatory curriculum in the afternoon shift with full access to school facilities and certified faculty.
                                </p>
