...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Prep B Class" />
            <HeaderOne />
            <BreadCrumb title="Prep B Class" innerTitle="Prep B Class" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Prep B Class</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Comprehensive preparatory curriculum cultivating independent thinking, cooperative learning, and foundational academic proficiency.
                                </p>
