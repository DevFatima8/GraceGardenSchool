...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Grade 7-C (Cambridge)" />
            <HeaderOne />
            <BreadCrumb title="Grade 7-C (Cambridge)" innerTitle="Grade 7-C (Cambridge)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                ...
                                <h2 className="mb-4 text-dark fw-bold">Grade 7-C (Cambridge)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Advanced critical thinking, global perspectives, scientific research projects, and active problem solving.
                                </p>
