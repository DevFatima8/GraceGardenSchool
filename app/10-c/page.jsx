...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Grade 10-C (Cambridge O-Level)" />
            <HeaderOne />
            <BreadCrumb title="Grade 10-C (Cambridge O-Level)" innerTitle="Grade 10-C (Cambridge O-Level)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Cambridge O-Level Final Year</span>
                                <h2 className="mb-4 text-dark fw-bold">Grade 10-C (Cambridge O-Level)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Intensive O-Level exam prep, past paper marathons, conceptual masterclasses, and college counseling support.
                                </p>
