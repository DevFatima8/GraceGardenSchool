...
const Page = () => {
    return (
        <>
            <SEO pageTitle="Grade 6-C (Cambridge)" />
            <HeaderOne />
            <BreadCrumb title="Grade 6-C (Cambridge)" innerTitle="Grade 6-C (Cambridge)" />
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            <div className="card border-0 shadow-sm p-4 p-md-5 rounded-4 mb-4">
                                <span className="text-primary fw-bold fs-6 mb-2 d-inline-block">Cambridge Lower Secondary Pathway</span>
                                <h2 className="mb-4 text-dark fw-bold">Grade 6-C (Cambridge)</h2>
                                <p className="lead text-muted mb-4" style={{ lineHeight: "1.8" }}>
                                    Inquiry-based Cambridge Lower Secondary curriculum emphasizing international benchmarks in English, Math, and Science (Checkpoint).
                                </p>
