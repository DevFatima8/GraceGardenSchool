...
const PAGES = [
  ...
  { slug: 'character-conduct', name: 'Character and Conduct' },
  { slug: 'yearly-competitions', name: 'Yearly Competitions' },
  { slug: 'virtual-tour', name: 'Virtual Tour' },
  { slug: 'school-uniform', name: 'School Uniform' },
  // Nested Yearly Competitions
  { slug: 'annual-sports-meet', name: 'Annual Sports Meet' },
  { slug: 'brain-competition', name: 'Brain of Grace Garden' },
  { slug: 'literary-competition', name: 'Literary Competition' },
  // Nested Facilities
  { slug: 'computer-lab', name: 'Computer Lab' },
  { slug: 'science-lab', name: 'Science Lab' },
  { slug: 'club-activity', name: 'Club Activity' },
  { slug: 'extra-courses', name: 'Extra Courses' },
  // Nested Events
  { slug: 'school-day', name: 'School Day' },
  { slug: 'celebrations', name: 'Celebrations' },
  { slug: 'science-art-exhibition', name: 'Science & Art Exhibition' },
  { slug: 'annual-drama', name: 'Annual Drama' },
];

export default function OurSchoolPageManager() {
  ...
  return (
    <div>
      <h3 className="fw-bold mb-4">Manage Our School Pages</h3>
      ...
      {loading ? (
        ...
        <div className="card shadow-sm border-0">
          <div className="list-group list-group-flush">
            {content.length === 0 ? (
              <div className="p-4 text-muted text-center">No custom sections added yet. The default content is currently being shown on the website. Add a section to override the defaults! (Note: to override default sections, use their exact IDs like 'hero', 'intro', etc. or just add new ones.)</div>
            ) : (
              content.map((section) => {
                let listCount = 0;
            ...
            <div className="modal-content border-0 shadow-lg rounded-4">
              ...
              <div className="modal-body p-4 p-md-5">
                <form id="editForm" onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4">
                    <label className="form-label fw-bold">Section ID <small className="text-muted fw-normal">(Required. Use 'hero' for banner image)</small></label>
                        ...
                        {formData.json_data[activeListIndex] && (
                          <div className="card shadow-sm border-primary">
                            <div className="card-body bg-light rounded position-relative">
                              ...
                              <h6 className="fw-bold mb-3" style={{ color: 'var(--primary-color-1)' }}>Editing Card #{activeListIndex + 1}</h6>
                              
                              <div className="row g-3">
                                <div className="col-md-6">
                                  <label className="form-label small fw-bold">Card Title</label>
                                ...
                                <div className="col-12">
                                  <label className="form-label small fw-bold d-block">Image / Icon</label>
                                  <div className="d-flex align-items-center gap-2">
                                    ...
                                    <input type="text" className="form-control form-control-sm" placeholder="URL" value={formData.json_data[activeListIndex].image_url || ''} onChange={(e) => handleListChange(activeListIndex, 'image_url', e.target.value)} />
