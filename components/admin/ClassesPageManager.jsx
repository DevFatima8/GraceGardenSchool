...
const PAGES = [
  { slug: 'pre-nursery', name: 'Pre Nursery (Pre School)' },
  { slug: 'nursery-a', name: 'Nursery A (Pre School)' },
  { slug: 'nursery-b', name: 'Nursery B (Pre School)' },
  { slug: 'prep-a', name: 'Prep A (Pre School)' },
  { slug: 'prep-b', name: 'Prep B (Pre School)' },
  { slug: '1-a', name: 'Class 1 A (Primary)' },
  { slug: '1-b', name: 'Class 1 B (Primary)' },
  { slug: '2-a', name: 'Class 2 A (Primary)' },
  { slug: '2-b', name: 'Class 2 B (Primary)' },
  { slug: '3-a', name: 'Class 3 A (Primary)' },
  { slug: '3-b', name: 'Class 3 B (Primary)' },
  { slug: '4-a', name: 'Class 4 A (Primary)' },
  { slug: '4-b', name: 'Class 4 B (Primary)' },
  { slug: '5-a', name: 'Class 5 A (Primary)' },
  { slug: '5-b', name: 'Class 5 B (Primary)' },
  { slug: '6-a', name: 'Class 6 A (Middle)' },
  { slug: 'nursery-e', name: 'Nursery E (2nd Shift)' },
  { slug: 'prep-e', name: 'Prep E (2nd Shift)' },
  { slug: '1-e', name: 'Class 1 E (2nd Shift)' },
  { slug: '2-e', name: 'Class 2 E (2nd Shift)' },
  { slug: '3-e', name: 'Class 3 E (2nd Shift)' },
  { slug: '4-e', name: 'Class 4 E (2nd Shift)' },
  { slug: '5-e', name: 'Class 5 E (2nd Shift)' },
  { slug: '6-e', name: 'Class 6 E (2nd Shift)' }
];

export default function ClassesPageManager() {
  ...
  return (
    <div>
      <h3 className="fw-bold mb-4">Manage Class Pages</h3>
          ...
          <div className="list-group list-group-flush">
            {content.length === 0 ? (
              <div className="p-4 text-muted text-center">
                ...
                <br/><small>(Note: to override page defaults, use section IDs: <b>overview</b>, <b>why_ggs</b>, <b>process</b>)</small>
              </div>
            ) : (
              content.map((section) => {
                let listCount = 0;
