...
const PAGES = [
  { slug: 'ace', name: 'ACE (Academic Excellence)' },
  { slug: 'set', name: 'SET (Student Evaluation)' },
  { slug: 'pre-school', name: 'Pre-School Coordinator' },
  { slug: 'lower-primary', name: 'Lower Primary Coordinator' },
  { slug: 'upper-primary', name: 'Upper Primary Coordinator' },
  { slug: 'middle', name: 'Middle Section Coordinator' }
];

export default function DepartmentsPageManager() {
  ...
  return (
    <div>
      <h3 className="fw-bold mb-4">Manage Department Pages</h3>
